...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_actionOverRiderProperty = serializedObject.FindProperty("m_OverRideActiononLabel");
            m_actionOverRiderStringProperty = serializedObject.FindProperty("m_ActionLabelString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_actionOverRiderProperty);
                if (m_rebindActionUI.m_OverRideActiononLabel)
                {
                    EditorGUILayout.PropertyField(m_actionOverRiderStringProperty);
                }
        ...
        private SerializedProperty m_actionOverRiderProperty;
        private SerializedProperty m_actionOverRiderStringProperty;
